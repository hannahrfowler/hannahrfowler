...
**`Software Engineer`** **`Musician`** **`Creative Coder`** **`Loves to Learn`**
...
[![My Skills](https://skillicons.dev/icons?i=html,css,sass,js,nodejs,react,typescript,vite,python,django,java,vscode,git,aws,docker,postman,postgres)](https://skillicons.dev)
